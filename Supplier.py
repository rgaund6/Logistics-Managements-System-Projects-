 ...
 #======================================================================================================================       
    ...
    def add(self):
        ...
        try:
           ...
           if not name:
            messagebox.showerror("Error", "Name must not be empty", parent=self.root)
            return
           if not re.match(r"^[A-Za-z\s]+$", name):
            messagebox.showerror("Error", "Name must contain only alphabets and spaces", parent=self.root)
           else:
            ...
            if row!=None:
                    ...
                    con.commit()
                    messagebox.showinfo("Successs","Supplier Added Successfully")
                    self.show()
        ...
        try:
            if self.var_sup_invoice.get()=="":
                ...
                if row==None:
                    ...
                    con.commit()
                    messagebox.showinfo("Successs","Supplier Updated Successfully")
                    self.show()
        except Exception as ex:
            messagebox.showerror("Error",f"Error due to : {str(ex)}",parent=self.root) 
