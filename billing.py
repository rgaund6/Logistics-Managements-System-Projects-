...
class BillClass:
    def __init__(self,root):
        ...
        footer=Label(self.root,text="Logistics Managements System | Developed By Raj\nFor any Issue contact: 987xxxxx01",font=("times new roman",11),bg="#4d636d",fg="white").pack(side=BOTTOM,fill=X)
