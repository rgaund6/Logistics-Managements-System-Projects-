...
class SalesClass:
    def __init__(self,root):
        ...
        #========title==============
        lbl_title=Label(self.root,text="View Customer Bills",font=("goudy old style",28),bg="#184a45",fg="white",bd=3,relief=RIDGE).pack(side=TOP,fill=X,padx=10,pady=20)
