...
class categoryClass:
    def __init__(self,root):
        ...
        #===============Title===========================================
        lbl_title=Label(self.root,text="Manage product Category",font=("goudy old style",28),bg="#184a45",fg="white",bd=3,relief=RIDGE).pack(side=TOP,fill=X,padx=10,pady=20)

        lbl_name=Label(self.root,text="Enter Category Name",font=("goudy old style",24),bg="white").place(x=50,y=100)
        ...
        try:
            if self.var_name.get()=="":
                ...
                if row!=None:
                    ...
                    con.commit()
                    messagebox.showinfo("Successs","Category Added Successfully")
                    self.show()
